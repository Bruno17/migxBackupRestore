 ...
 * 
 * Author: H van der Voort
 * 
 * Extended 2015 by Bruno Perner
 *
...
?>
            ...
            echo "../" . date("Ymd-His") . "-" . strtolower($_SERVER['HTTP_HOST']) . ".zip";
...
?>">
            ...
            echo str_replace(realpath("./") . "/", "", __file__) . PHP_EOL . "core/cache" . PHP_EOL . "assets/components/phpthumbof/cache";
...
?>><a href="?action=zip">1. Create Backup</a></li>
            <li <?php

echo $unzipclass

?>><a href="?action=unzip">2. Extract</a></li>
            <li <?php

echo $configclass

?>><a href="?action=config">3. Configure</a></li>
            <li <?php

echo $dbimportclass . $dbimportfinishedclass

?>><a href="?action=dbimport">4. Import DB</a></li>
        </ul>
    </div>
