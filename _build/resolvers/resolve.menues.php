...
if ($object->xpdo) {
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $menues = $modx->fromJson('[{"MIGX_id":"1","text":"Site Backup","parent":"","description":"","icon":"","menuindex":"","params":"&configs=mbr_settings","handler":"","permissions":"","action.id":"","action.namespace":"","action.controller":"","action.haslayout":"0","action.lang_topics":"","action.assets":""}]');
